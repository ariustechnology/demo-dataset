...
from arius.company import SupplierPart, SupplierPriceBreak
from arius.part import Part
from arius.stock import StockItem

api = AriusAPI("http://localhost:8000", username="admin", password="arius")
